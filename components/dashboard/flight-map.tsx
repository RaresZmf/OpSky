...
export function FlightMap() {
  ...
  return (
    <div className="relative w-full h-[400px] bg-gray-800 rounded-b-lg overflow-hidden">
      <div ref={mapRef} className="w-full h-full">
        {!mapLoaded ? (
          ...
          <div className="relative w-full h-full">
            ...
            <div className="absolute inset-0 bg-[#1a2e3b]">
            ...
            <div className="absolute top-4 right-4 flex flex-col gap-2">
              <button className="bg-background/80 backdrop-blur-sm p-2 rounded-md hover:bg-background/90 transition-colors">
                <svg
